...
export default function NavbarTitle({ hover }: NavbarProps) {
    return (
        <div className="flex-1 gap-3">
            <Link href={'/'} className={`text-xl font-bold ${hover}`}>Home</Link>
            <label className={`swap swap-rotate ${hover}`}>
                {/* this hidden checkbox controls the state */}
                <input type="checkbox" className="theme-controller" value="valentine" aria-label="Theme Toggle" />
                {/* moon icon */}
